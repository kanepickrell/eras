    ...
    if (input.trim()) {
      ...
      try {
        ...
        if (response.ok) {
          ...
          typeWriterEffect(` Richard Nixon: ${data.response}`);
        } else {
  ...
  return (
    <div className={`chat-container ${showSidebar ? 'sidebar-shown' : ''}`}>
      ...
      <div id="chat-box" className="chat-box" ref={chatBoxRef} style={{ flex: 1, overflowY: 'auto' }}>
        {messages.map((msg, index) => (
          <div 
            ...
            className="message" 
            style={{ 
              backgroundColor: msg.isUser ? '#81b89f' : '#ffcc80', 
        ...
        {typingMessage && (
          <div 
            ...
            style={{ 
              backgroundColor: '#ffcc80',  // Ensure the typing message also uses the soft red color
      ...
      {showSpinner ? (
        ...
        // </div>
        <div className="spinner-container">
            <SpinnerDotted size={75} thickness={180} speed={60} color="#ffcc80" />
        </div>
      ) : isLLMResponding && (
      ...
      <div className="input-container">
        <input
          type="text"
          value={input}
          placeholder="Ask President Nixon..."
